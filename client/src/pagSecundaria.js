...
function PagSecundaria({ isDarkMode, setIsDarkMode }) {
    ...
    const fetchInitialMessages = () => {
        setChatMessages([
            ...
            { content: '¿Estás listo para mostrar todo lo que sabes y alcanzar nuevas metas? ¡Vamos a brillar juntos!', sender: 'bot1', timestamp: new Date() },
    ...
    const sendMessage = () => {
        ...
        fetch('http://localhost:3003/evaluar-examen', {
            ...
            .catch(error => {
                ...
                const errorMessage = { content: 'Error al evaluar el examen.', sender: 'bot1', timestamp: new Date() };
                setChatMessages(prevMessages => [...prevMessages, errorMessage]);
            });
    };
